...
namespace dxvk {
   ...
   *
   * The first vector stores the requested D3D11 color. The second stores
   * the emulation mode followed by the U/V/W border-axis masks. Mode 0
   * disables correction, 1 selects point filtering and 2 selects linear.
   */
